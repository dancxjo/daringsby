...
pub mod wits {
    ...
    pub use memory::{
        ...
        GraphImageDescription, GraphImageFrame, GraphImpressionTimelineItem, GraphMovieImageFrame,
...
pub use wits::{
    ...
    GraphImpressionTimelineItem, GraphMovieImageFrame, GraphMovieSpeechSegment, GraphNodeDetails,
