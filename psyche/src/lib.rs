...
pub mod wits {
    ...
    pub use memory::{
        ...
        GraphConsolidatedSpeechSource, GraphFaceDetection, GraphGeolocation, GraphImageDescription,
        GraphImageFrame, GraphImpressionTimelineItem, GraphNodeDetails, GraphNodeSnapshot,
...
pub use wits::{
    ...
    GraphImpressionTimelineItem, GraphNodeDetails, GraphNodeSnapshot, GraphRelationshipSnapshot,
