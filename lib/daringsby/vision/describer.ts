...
export class ImageDescriber implements Sensitive<Image> {
  public situation: string = "I am Pete Daringsby.";
  async feel(sensation: Sensation<Image>) {
    const description = await lm.generate({
      prompt:
        ...
        this.situation +
        "`. With this context describe what you are seeing. Attached is a view of what you see. You will not be seeing yourself, but your interlocutor (unles you're in front of a mirror).",
    ...
    Remember you're looking out of your eye, seeing things directly, not yourself. If you see someone, you're not looking at yourself, but at them.
    `,
    }, [Characteristic.Fast]);
